...
if (!window.$RefreshReg$ || !window.$RefreshSig$ || !window.$RefreshRuntime$) {
  ...
  window.$RefreshReg$ = (type, id) => {
    window.$RefreshRuntime$.register(type, '"app\\\\components\\\\DashboardLayout.tsx"' + id);
  };
...
if (import.meta) {
  ...
  import.meta.hot.lastModified = "1750111031106.2295";
}
var navigationItems = [{
  name: "Dashboard",
  icon: "\u{1F4CA}",
...
function DashboardLayout({
  ...
  const [isSidebarExpanded, setIsSidebarExpanded] = (0, import_react4.useState)(true);
  const [isMobileMenuOpen, setIsMobileMenuOpen] = (0, import_react4.useState)(false);
  ...
  return /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("div", { className: "min-h-screen bg-blue-50 flex flex-col lg:flex-row", children: [
    /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)(Oe, {}, void 0, false, {
      fileName: "app/components/DashboardLayout.tsx",
      lineNumber: 110,
      columnNumber: 13
    }, this),
    /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("div", { className: "lg:hidden bg-white shadow-md p-4", children: /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("div", { className: "flex justify-between items-center", children: [
      /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("h1", { className: "text-xl font-semibold text-blue-900", children: "JobPlatform" }, void 0, false, {
        fileName: "app/components/DashboardLayout.tsx",
        lineNumber: 114,
        columnNumber: 21
      }, this),
      /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("button", { onClick: () => setIsMobileMenuOpen(!isMobileMenuOpen), className: "p-2 rounded-md hover:bg-gray-100 text-gray-600 focus:outline-none", children: isMobileMenuOpen ? "\u2715" : "\u2630" }, void 0, false, {
        fileName: "app/components/DashboardLayout.tsx",
        lineNumber: 115,
        columnNumber: 21
      }, this)
    ...
    isMobileMenuOpen && /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("div", { className: "lg:hidden fixed inset-0 bg-black bg-opacity-50 z-40", onClick: () => setIsMobileMenuOpen(false) }, void 0, false, {
      fileName: "app/components/DashboardLayout.tsx",
      lineNumber: 122,
      columnNumber: 34
    }, this),
    /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("div", { className: `fixed lg:static inset-y-0 left-0 z-50 transform transition-transform duration-300 ease-in-out ${isMobileMenuOpen ? "translate-x-0" : "-translate-x-full lg:translate-x-0"} ${isSidebarExpanded ? "w-64" : "w-20"} bg-blue-900 text-white`, children: /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("div", { className: "h-full flex flex-col", children: [
      /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("div", { className: "p-4 flex items-center justify-between border-b border-blue-800", children: [
        isSidebarExpanded ? /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("h1", { className: "text-xl font-semibold text-white", children: "JobPlatform" }, void 0, false, {
          fileName: "app/components/DashboardLayout.tsx",
          lineNumber: 129,
          columnNumber: 46
        }, this) : /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("span", { className: "text-2xl", children: "JP" }, void 0, false, {
          fileName: "app/components/DashboardLayout.tsx",
          lineNumber: 129,
          columnNumber: 114
        }, this),
        /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("button", { onClick: () => setIsSidebarExpanded(!isSidebarExpanded), className: "hidden lg:block p-2 rounded-md hover:bg-blue-800 text-white cursor-pointer", children: isSidebarExpanded ? "\u25C0" : "\u25B6" }, void 0, false, {
          fileName: "app/components/DashboardLayout.tsx",
          lineNumber: 130,
          columnNumber: 25
        }, this)
      ...
      /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("nav", { className: "flex-1 p-4 space-y-2 overflow-y-auto", children: navigationItems.map((item) => /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)(Link, { to: item.path, className: "flex items-center space-x-3 p-3 rounded-md hover:bg-white hover:text-blue-900 text-blue-100 transition-colors cursor-pointer", onClick: () => setIsMobileMenuOpen(false), children: [
        /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("span", { className: "text-xl", children: item.icon }, void 0, false, {
          fileName: "app/components/DashboardLayout.tsx",
          lineNumber: 138,
          columnNumber: 33
        }, this),
        isSidebarExpanded && /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("span", { children: item.name }, void 0, false, {
          fileName: "app/components/DashboardLayout.tsx",
          lineNumber: 139,
          columnNumber: 55
        }, this)
      ...
      /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("div", { className: "p-4 border-t border-blue-800", children: /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("div", { className: "flex items-center space-x-3", children: [
        /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("div", { className: "w-8 h-8 rounded-full bg-blue-700 flex items-center justify-center text-white", children: user?.name?.[0]?.toUpperCase() || "U" }, void 0, false, {
          fileName: "app/components/DashboardLayout.tsx",
          lineNumber: 146,
          columnNumber: 29
        }, this),
        isSidebarExpanded && /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("div", { className: "flex-1 min-w-0", children: [
          /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("p", { className: "text-sm font-medium text-white truncate", children: user?.name }, void 0, false, {
            fileName: "app/components/DashboardLayout.tsx",
            lineNumber: 150,
            columnNumber: 37
          }, this),
          /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("p", { className: "text-xs text-blue-200 truncate", children: user?.email }, void 0, false, {
            fileName: "app/components/DashboardLayout.tsx",
            lineNumber: 153,
            columnNumber: 37
          }, this)
    ...
    /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("div", { className: "flex-1 flex flex-col min-h-screen", children: [
      /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("nav", { className: "bg-white shadow-md", children: /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("div", { className: "px-4 sm:px-6 lg:px-8", children: /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("div", { className: "flex justify-between h-16", children: [
        /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("div", { className: "hidden lg:flex items-center", children: /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("h2", { className: "text-xl font-semibold text-blue-900", children: title }, void 0, false, {
          fileName: "app/components/DashboardLayout.tsx",
          lineNumber: 167,
          columnNumber: 33
        }, this) }, void 0, false, {
        ...
        /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("div", { className: "flex items-center space-x-4", children: [
          /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("button", { className: "relative p-2 text-gray-600 hover:text-blue-600 focus:outline-none cursor-pointer", children: [
            /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("span", { className: "text-xl", children: "\u{1F514}" }, void 0, false, {
              fileName: "app/components/DashboardLayout.tsx",
              lineNumber: 172,
              columnNumber: 37
            }, this),
            /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("span", { className: "absolute top-0 right-0 inline-flex items-center justify-center px-2 py-1 text-xs font-bold leading-none text-white transform translate-x-1/2 -translate-y-1/2 bg-red-600 rounded-full", children: "3" }, void 0, false, {
              fileName: "app/components/DashboardLayout.tsx",
              lineNumber: 173,
              columnNumber: 37
            }, this)
          ...
          /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("button", { onClick: handleLogout, className: "bg-blue-600 text-white px-4 py-2 rounded-md text-sm font-medium hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500 cursor-pointer", children: "Logout" }, void 0, false, {
            fileName: "app/components/DashboardLayout.tsx",
            lineNumber: 177,
            columnNumber: 33
          }, this)
      ...
      /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("main", { className: "flex-1 p-4 sm:p-6", children }, void 0, false, {
        fileName: "app/components/DashboardLayout.tsx",
        lineNumber: 186,
        columnNumber: 17
      }, this)
...
_s(DashboardLayout, "dvGTuHQYkZfoMWuavoJ6H6xiBio=", false, function() {
...
//# sourceMappingURL=/build/_shared/chunk-M425YDXV.js.map
